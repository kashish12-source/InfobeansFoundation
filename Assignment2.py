...
total_quant5 = (50*quant_5)-(50*quant_5)*0.01

total_quant10 = (100*quant_10)-(100*quant_10) *0.15
if quant_1>4:
    quant1_dis =(10*quant_1)-((10*quant_1) * 0.05 )
    
else:
    quant1_dis =(10*quant_1)
actual_price = (10*quant_1) + (20*quant_2) +(30*quant_3) + (40*quant_4) + (50*quant_5) + (60*quant_6) + (70*quant_7) +(80*quant_8) + (90*quant_9) + (100*quant_10)
...
print("----------------------------------------------------------------------------")
print(f"\t\t\t\t\t A.P\t\tD.P")
print(f"\t\t\t\t\t{actual_price:.2f}\t{bill:.2f}")
print(f"Gift :- {Gift} \t\t\t 0.0\t\t0.0 \n")
print(f"Carry Bag : {carrybag}\t\t\t\t{x}\t\t{x}")
print(f"GST : 10% \t\t\t\t{gst:.2f}\t\t{gst:.2f}")
print("----------------------------------------------------------------------------")
print(f" \t\t\t\t\t{actual_price+gst:.2f}\t{total_bill:.2f}")
print(f"\t\t\t\tThank You")
print(f"\t\t\t         To Vist")
print(f"\t\t\t          D-Mart")